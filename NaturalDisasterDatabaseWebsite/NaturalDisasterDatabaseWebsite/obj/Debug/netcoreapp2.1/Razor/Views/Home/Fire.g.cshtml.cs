#pragma checksum "F:\bishe\NaturalDisasterDatabaseWebsite\NaturalDisasterDatabaseWebsite\Views\Home\Fire.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3da4ddf0c41c26f96aa0439f795f4b198de11e79"
// <auto-generated/>
...
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Home/Fire.cshtml", typeof(AspNetCore.Views_Home_Fire))]
...
#line default
#line hidden
#line 1 "F:\bishe\NaturalDisasterDatabaseWebsite\NaturalDisasterDatabaseWebsite\Views\Home\Fire.cshtml"
using System.Security.Claims;

#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3da4ddf0c41c26f96aa0439f795f4b198de11e79", @"/Views/Home/Fire.cshtml")]
    ...
    public class Views_Home_Fire : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            EndContext();
#line 4 "F:\bishe\NaturalDisasterDatabaseWebsite\NaturalDisasterDatabaseWebsite\Views\Home\Fire.cshtml"
 if (User.Identity.IsAuthenticated)
{

#line default
#line hidden
            BeginContext(149, 17853, true);
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    for (var i = 0; i < res.firelist.length; i++) {
                        ...
                        fMAnum[i] = res.firelist[i].ffMajorNumbe");
            WriteLiteral(@"rs;
                        ...
                        toolbox: {
                            ...
                            feature: {
                                dataView: { //数据视图
                                    ...
                                    lang: ['', '关闭', '导出Excel'],
                        ");
            WriteLiteral(@"            buttonColor: '#30C76C',
                                    iconStyle: {
                                        borderColor: '#fff'
                                    },
                                    emphasis: {
                                    ...
                                    contentToOption: function (opts) {
                                        ...
                                        $(""#tableExcel_Fire"").table2excel({ //通过id即tableExcel_Day
                                            ...
                                            filename: ""广西森林火灾起数"" + new Date().getTime() + """);
            WriteLiteral(@".xls"", //文件名称
                                            exclude_img: true,
                                            exclude_links: true,
                                            exclude_inputs: true
                                        });
                                    ...
                                    optionToContent: function (opt) {
                                        ...
                                        var table = '<div style=""overflow-y:auto;height: 100%");
            WriteLiteral(@";width:100%;""><table id=""tableExcel_Fire"" class=""table-bordered table-striped"" style=""text-align:center; border-collapse:collapse; margin:0 auto; text-align:center;"" border=""1"" ><tbody><tr>' + tdHeaders + '</tr>';
                                        var tdBodys = ''; // 表数据
 ...
 ");
            WriteLiteral(@"                               //console.log(e)
                        ...
                        xAxis: {
                          ...
                          ");
            WriteLiteral(@"          return _v === 0 ? _v : _v + '%';
                                }
                            },
                            axisLine: {
                                show: false
...
");
            EndContext();
#line 370 "F:\bishe\NaturalDisasterDatabaseWebsite\NaturalDisasterDatabaseWebsite\Views\Home\Fire.cshtml"
}
else
{
            ...
            WriteLiteral(@"   }
                        ...
                        tooltip: {
                            ...
                            formatter: function (e) {
                                //console.log(e)
                                ");
            WriteLiteral(@"var str = '<div style=""border-bottom: 1px solid rgba(255,255,255,.3); font-size: 18px;padding-bottom: 7px;margin-bottom: 7px; text-align:center;"">' + '广西 ' + e[0].name + ' 年' + '</div>';
                                for (var q = 0; q < e.length; q++) {
                                    str += e[q].seriesName + ""："" + '<span>&nbsp;&nbsp;</span>' + e[q].data + '次<br />';
                                }
                                return str;
                        ...
                        yAxis: [{
                            ...
                            axisLabel: {
                                ...
                                textStyle: {
                                    verticalAlign: 'middle',
 ");
            WriteLiteral(@"                                   color: '#fff',  //坐标的字体颜色
                                },
                            },
                            axisLine: {
                                show: true,
...
");
            EndContext();
#line 658 "F:\bishe\NaturalDisasterDatabaseWebsite\NaturalDisasterDatabaseWebsite\Views\Home\Fire.cshtml"
}

#line default
#line hidden
            BeginContext(30669, 1526, true);
            WriteLiteral(@"
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (res) {
                    ...
                    whiteb[0] = 99;
           ");
            WriteLiteral(@"         myFireCaCharts.hideLoading();
    ...
    function jingjiLoss() {
        ...
        $(document).ready(function () {
            $.ajax({
               ...
               ");
            WriteLiteral(@"         dataShadow.push(yMax);
                    }
            ...
            WriteLiteral(@"ow: false
                        ...
                        series: [
                            { // For shadow
                                ...
                                itemStyle: {
                              ");
            WriteLiteral(@"      color: 'rgba(0,0,0,0.05)'
                                },
                                barGap: '-100%',
                                barCategoryGap: '40%',
                                data: dataShadow,
